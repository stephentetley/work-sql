...
-- TODO needs to check a worklist t
...
-- FROM ai2_classrep.equi_extra_masterdata t;

-- DESCRIBE SELECT * FROM ai2_classrep.equi_extra_masterdata;

-- DESCRIBE SELECT * FROM s4_classrep;
