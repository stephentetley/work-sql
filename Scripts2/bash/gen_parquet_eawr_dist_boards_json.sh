...
copy (select * from eawr_dist_board_load) to '$2/eawr_dist_board_loads.parquet' (format parquet, compression snappy);
EOF

    echo "Created $2/eawr_dist_board_loads.parquet"
else
