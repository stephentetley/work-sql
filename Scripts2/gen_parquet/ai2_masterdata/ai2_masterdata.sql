...
create or replace table ai2_floc (
    ...
    -- e.g. 'WATERFALL/WPS/WATER SERVICES/PUMPING'
    common_name varchar,
    -- e.g. 'OPERATIONAL'
    user_status varchar,
    -- e.g. 'WATER SERVICES'
    ...
    -- e.g. 'SAI00123456', maybe null for type 2 sites
    site_sainum varchar,
    -- e.g. 'BRUNSWICK COMPLEX', maybe null for type 2 sites
    site_name varchar,
    -- e.g. 'SAI00001340'
    installation_or_subinstallation_sainum varchar,
    -- e.g. 'SITENAME/SPS'
    installation_or_subinstallation_name varchar,
    installation_or_subinstallation_type_code varchar,
    process_group_sainum varchar,
    process_sainum varchar,
    plant_sainum varchar,
    sub_plant_sainum varchar,
    plantitem_sainum varchar,
    sub_plantitem_sainum varchar,
...
select
    ...
    t."InstallationTypeCode" as installation_type_code,
    t."InstallationTypeDescription" as type_decription,
    t."SiteReference" as site_sainum,
...
select
    ...
    t."SubInstallationTypeCode" as sub_installation_type_code,
...
select 
    ...
    t.site_sainum,
    t.site_name,
    t.sai_reference as installation_or_subinstallation_sainum,
    t.common_name as installation_or_subinstallation_name,
    t.installation_type_code as installation_or_subinstallation_type_code,
    null as process_group_sainum,
    null as process_sainum,
    null as plant_sainum,
    null as sub_plant_sainum,
    null as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select 
    ...
    t.sai_reference as installation_or_subinstallation_sainum,
    t.common_name as installation_or_subinstallation_name,
    t.sub_installation_type_code as installation_or_subinstallation_type_code,
    null as process_group_sainum,
    null as process_sainum,
    null as plant_sainum,
    null as sub_plant_sainum,
...
select 
    ...
    coalesce(t."SubInstallationReference", 
        t."InstallationReference") as installation_or_subinstallation_sainum,
    coalesce(t."SubInstallationCommonName", 
        t."InstallationCommonName") as installation_or_subinstallation_name,
    coalesce(t."SubInstallationTypeCode", 
        t."InstallationTypeCode") as installation_or_subinstallation_type_code,
    t.sai_reference as process_group_sainum,
    null as process_sainum,
    null as plant_sainum,
    null as sub_plant_sainum,
    null as plantitem_sainum,
...
select
    ...
    coalesce(t."SubInstallationTypeCode", 
        t."InstallationTypeCode") as installation_or_subinstallation_type_code,
    t."ProcessGroupReference" as process_group_sainum,
    t.sai_reference as process_sainum,
    null as plant_sainum,
    null as sub_plant_sainum,
    null as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select
    ...
    coalesce(t."SubInstallationTypeCode", 
        t."InstallationTypeCode") as installation_or_subinstallation_type_code,        
    t."ProcessGroupReference" as process_group_sainum,
    t."ProcessReference" as process_sainum,
    t.sai_reference as plant_sainum,
    null as sub_plant_sainum,
    null as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select
    ...
    t."ProcessGroupReference" as process_group_sainum,
    t."ProcessReference" as process_sainum,
    t."PlantReference" as plant_sainum,
    t.sai_reference as sub_plant_sainum,
    null as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select
    ...
    t."ProcessReference" as process_sainum,
    t."PlantReference" as plant_sainum,
    t."SubPlantReference" as sub_plant_sainum,
    t.sai_reference as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select
    ...
    t."PlantReference" as plant_sainum,
    t."SubPlantReference" as sub_plant_sainum,
    t."PlantItemReference" as plantitem_sainum,
    t.sai_reference as sub_plantitem_sainum,
...
select 
    ...
    t."ProcessReference" as process_sainum,
    t."PlantReference" as plant_sainum,
    t.sai_number as sub_plant_sainum,
    null as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select 
    ...
    t."PlantReference" as plant_sainum,
    t."SubPlantReference" as sub_plant_sainum,
    t.sai_number as plantitem_sainum,
    null as sub_plantitem_sainum,
...
select 
    ...
    t."SubPlantReference" as sub_plant_sainum,
    t."PlantItemReference" as plantitem_sainum,
    t.sai_number as sub_plantitem_sainum,        
